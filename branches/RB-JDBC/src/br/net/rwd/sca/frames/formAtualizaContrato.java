...
private void jButtonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarActionPerformed
    try {
        ...
        dataFim.add(GregorianCalendar.MONTH, prazo =  prazo -1);
        ...
        contrato.setPrazo(prazo =  prazo +1);
...
private void jFormattedTextFieldValorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFormattedTextFieldValorKeyReleased
    ...
    private void carregaLocador() {
        try {
            ...
            Logger.getLogger(formAtualizaContrato.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
