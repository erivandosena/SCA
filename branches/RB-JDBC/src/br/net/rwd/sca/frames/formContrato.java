...
private void jButtonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoverActionPerformed
    ...
    if (resultado == 0) {
        ...
        try {
            if (dao.isCarneAtivoContrato(codContrato)) {
                JOptionPane.showMessageDialog(this, "Contrato possui carnê(s).", "Informação", JOptionPane.INFORMATION_MESSAGE);
                return;
            } else {
...
private void jButtonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImprimirActionPerformed
        ...
        ContratoDAO instanciaContrato = new ContratoDAO();
        try {
            JasperViewer jv = new JasperViewer(instanciaContrato.imprime(contratos.get(jTableContratos.getSelectedRow()).getNumero()), false);
            this.setVisible(false);
            jv.setVisible(true);
            jv.setTitle("Contrato");  
            jv.setIconImage(new ImageIcon("icone.gif").getImage());  
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
...
private void jButtonPdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPdfActionPerformed
        ...
        try {
            ...
            JasperExportManager.exportReportToPdfFile(instanciaContrato.imprime(numero), arquivo);
            this.setVisible(false);
