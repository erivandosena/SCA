...
private void jButtonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImprimirActionPerformed
    ...
    CarneDAO instanciaContrato = new CarneDAO();
    try {
        JasperViewer jv = new JasperViewer(instanciaContrato.imprime(carnes.get(jTableCarne.getSelectedRow()).getCodigo()), false);
...
private void jTableCarneFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTableCarneFocusGained
    ...
    public final void carregaCarnes() {
        try {
            carnes = dao.selecionaTodosCarnes();
    ...
    private void carregaMensalidades(Carne carne) {
        try {
            mensalidades = dao.selecionaMensalidades(carne);
