 ...
 * @author Erivando
 */
public class formAdicionaCarne extends javax.swing.JDialog {
    ...
    public formAdicionaCarne(java.awt.Frame parent, boolean modal, CarneDAO dao, formCarne controle) {
        super(parent, modal);
        this.dao = dao;
...
private void jButtonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarActionPerformed
    try {
        ...
        if (!((Contrato) jComboBoxContrato.getSelectedItem()).getLocatario().isStatus()) {
